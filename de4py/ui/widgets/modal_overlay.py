...
from de4py.ui.motion.spring import DampedSpring, spring_gentle, spring_settle, InertiaChain
from de4py.ui.motion.material import MaterialState, MaterialPainter, set_wake_callback
...
class ModalOverlay(QWidget):
    ...
    def fade_out(self):
        ...
        self._translate_spring.value = self._translate_spring.value
