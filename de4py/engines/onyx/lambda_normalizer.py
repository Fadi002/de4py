...
def _is_const_like_node(node: ast.expr) -> bool:
    """True for nodes safe to inline at multiple load sites: scalars and
    tuples of scalars. Mutable containers are excluded - a fresh literal per
    site would give each reference its own object and change behavior."""
