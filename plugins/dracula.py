...
QFrame#SidebarLine
{
background-color:qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 transparent,stop:0.5 rgba(189, 147, 249, 0.8),stop:1 transparent);
max-height:2px;
margin-bottom:10px
}
QFrame#SettingsSeparator{background-color:qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 transparent,stop:0.5 rgba(189, 147, 249, 0.8),stop:1 transparent);border:none;max-height:1px;margin:8px 0}
...
QPushButton:hover
{
background-color:rgba(255, 121, 198, 0.85);
color:#ffffff;
...
min-height:50px;
border:none;
qproperty-iconColorName:"#FF79C6"
}
...
background:transparent;
border:none;
qproperty-pillBgIdle:rgba(40, 42, 54, 230);
qproperty-pillBgHover:rgba(40, 42, 54, 245);
qproperty-pillBgFocus:rgba(40, 42, 54, 255);
qproperty-pillBorderIdle:rgba(189, 147, 249, 76);
qproperty-pillBorderHover:rgba(189, 147, 249, 130);
qproperty-pillBorderFocus:rgba(189, 147, 249, 255);
qproperty-accent:rgba(189, 147, 249, 255);
qproperty-ring:rgba(255, 121, 198, 255);
qproperty-textMuted:rgba(248, 248, 242, 160)
}
...
min-height:0;
color:#F8F8F2;
selection-background-color:rgba(189, 147, 249, 200)
}
...
QWidget#NavCapsule
{
qproperty-bgIdle:rgba(248, 248, 242, 13);
qproperty-bgHover:rgba(248, 248, 242, 22);
qproperty-borderIdle:rgba(189, 147, 249, 40);
qproperty-borderHover:rgba(189, 147, 249, 90);
qproperty-divider:rgba(189, 147, 249, 30);
qproperty-iconIdle:rgba(248, 248, 242, 180);
qproperty-iconPressed:#F8F8F2
}

QWidget#SearchClearBtn
{
qproperty-hoverBg:rgba(255, 80, 80, 40);
qproperty-icon:rgba(248, 248, 242, 180);
qproperty-iconHover:#F8F8F2
}
