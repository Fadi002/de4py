...
QFrame#SettingsSeparator{background-color:qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 transparent,stop:0.5 rgba(166, 226, 46, 0.8),stop:1 transparent);border:none;max-height:1px;margin:8px 0}
...
background:transparent;
border:none;
qproperty-pillBgIdle:rgba(45, 42, 46, 230);
qproperty-pillBgHover:rgba(45, 42, 46, 245);
qproperty-pillBgFocus:rgba(45, 42, 46, 255);
qproperty-pillBorderIdle:rgba(252, 152, 103, 76);
qproperty-pillBorderHover:rgba(252, 152, 103, 130);
qproperty-pillBorderFocus:rgba(252, 152, 103, 255);
qproperty-accent:rgba(252, 152, 103, 255);
qproperty-ring:rgba(166, 226, 46, 255);
...
min-height:0;
color:#F8F8F2;
selection-background-color:rgba(252, 152, 103, 200)
}
...
qproperty-borderIdle:rgba(252, 152, 103, 40);
qproperty-borderHover:rgba(252, 152, 103, 90);
qproperty-divider:rgba(252, 152, 103, 30);
