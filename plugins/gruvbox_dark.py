...
class GruvboxDark(ThemePlugin):
    def __init__(self):
        super().__init__()
        self.name = "Gruvbox Dark"
        self.description = "Retro earthy dark theme with warm, vibrant highlights."
...
{
background-color:rgba(40, 40, 40, 0.85);
border:1px solid rgba(251, 73, 52, 0.5);
border-radius:14px;
padding:20px
}
...
QFrame#SidebarLine
{
background-color:qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 transparent,stop:0.5 rgba(250, 189, 47, 0.8),stop:1 transparent);
max-height:2px;
margin-bottom:10px
}
QFrame#SettingsSeparator{background-color:qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 transparent,stop:0.5 rgba(250, 189, 47, 0.8),stop:1 transparent);border:none;max-height:1px;margin:8px 0}
...
{
qproperty-borderColor:#FB4934;
qproperty-borderWidth:1.5;
qproperty-overlayColorName:#D2191919;
qproperty-iconColorName:#ffEBDBB2;
border-radius:14px;
...
QPushButton:hover
{
background-color:rgba(251, 73, 52, 0.85);
color:#ffffff;
...
min-height:50px;
border:none;
qproperty-iconColorName:"#FB4934"
}
...
border-radius:8px;
padding:8px 12px;
selection-background-color:#FB4934;
...
{
border:1px solid rgba(250, 189, 47, 0.5);
background-color:rgba(40, 40, 40, 0.8)
}
...
{
background:rgba(250, 189, 47, 0.4);
min-height:20px;
border-radius:3px
}
...
{
background:rgba(250, 189, 47, 0.8)
}
...
background:transparent;
border:none;
qproperty-pillBgIdle:rgba(40, 40, 40, 230);
qproperty-pillBgHover:rgba(40, 40, 40, 245);
qproperty-pillBgFocus:rgba(40, 40, 40, 255);
qproperty-pillBorderIdle:rgba(251, 73, 52, 76);
qproperty-pillBorderHover:rgba(251, 73, 52, 130);
qproperty-pillBorderFocus:rgba(251, 73, 52, 255);
qproperty-accent:rgba(251, 73, 52, 255);
qproperty-ring:rgba(250, 189, 47, 255);
qproperty-textMuted:rgba(235, 219, 178, 160)
}
...
min-height:0;
color:#EBDBB2;
selection-background-color:rgba(251, 73, 52, 200)
}
...
QWidget#NavCapsule
{
qproperty-bgIdle:rgba(235, 219, 178, 13);
qproperty-bgHover:rgba(235, 219, 178, 22);
qproperty-borderIdle:rgba(251, 73, 52, 40);
qproperty-borderHover:rgba(251, 73, 52, 90);
qproperty-divider:rgba(251, 73, 52, 30);
qproperty-iconIdle:rgba(235, 219, 178, 180);
qproperty-iconPressed:#EBDBB2
}

QWidget#SearchClearBtn
{
qproperty-hoverBg:rgba(255, 80, 80, 40);
qproperty-icon:rgba(235, 219, 178, 180);
qproperty-iconHover:#EBDBB2
}
...
QWidget#Sidebar {
    ...
    border-right: 2px solid rgba(251, 73, 52, 0.4);
    qproperty-glow_color: #FB4934;
}
QLabel#SidebarTitle {
    color: #FB4934;
    background: transparent;
